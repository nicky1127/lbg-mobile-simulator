...
const ScreenContainer = () => {
  return (
    <div className="w-screenWidth h-screenHeight min-h-[650px] relative border-[15px] border-solid border-darkGray rounded-[60px] overflow-hidden m-auto my-8 bg-gray-900">
      <div
        id="statusBar"
      ...
      <div
        id="mainContainer"
        className="max-w-full max-h-full pb-[2rem] bg-white flex relative z=[1]"
      >
        <div
          id="mainWrapper"
        ...
        >
          ...
          <div
            id="tabContainer"
            className="w-full border-t border-t-[rgb(216,216,216)] bg-white flex"
          >
            <TabList />
          </div>
        </div>
