  ...
  return (
    <div id={id} className="flex flex-col h-full">
      ...
      <div id="card_carousel" className=" py-[25px] flex justify-center">
        {cards.map((card) => (
          <div className="bg-ltbGreen3 w-[200px] h-[130px] shadow-[10px_8px_20px_rgba(0,0,0,0.4)] rounded-[10px] px-[10px] py-[10px] flex flex-col justify-between">
      ...
      <div id="actionWrapper" className=" bg-white p-[10px] flex-1  ">
        ...
        <div class="grid grid-cols-3 gap-4 p-[10px]">
          {actions.map((action) => (
